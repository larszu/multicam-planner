...
describe('shadeHex', () => {
  it('dunkelt gleichmäßig ab', () => {
    expect(shadeHex('#808080', 0.5)).toBe('#404040');
  });

  it('lässt factor 1 unverändert', () => {
    expect(shadeHex('#3b82f6', 1)).toBe('#3b82f6');
  });

  it('kappt bei Weiss statt überzulaufen', () => {
