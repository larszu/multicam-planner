...
export const LENSES: Lens[] = [
  ...
  { id: 'dzo-vespid-16', manufacturer: 'DZOFilm', model: 'Vespid 16mm T2.8', focalLengthMin: 16, focalLengthMax: 16, maxApertureWide: 2.8, mount: 'PL', imageCircle: 'FF', type: 'prime' },
  ...
  { id: 'zeiss-supreme-15', manufacturer: 'Zeiss', model: 'Supreme Prime 15mm T1.8', focalLengthMin: 15, focalLengthMax: 15, maxApertureWide: 1.8, mount: 'PL', imageCircle: 'FF', type: 'prime' },
  ...
  { id: 'zeiss-supreme-150', manufacturer: 'Zeiss', model: 'Supreme Prime 150mm T1.8', focalLengthMin: 150, focalLengthMax: 150, maxApertureWide: 1.8, mount: 'PL', imageCircle: 'FF', type: 'prime' },
  ...
  { id: 'fuj-cabrio-85-300', manufacturer: 'Fujinon', model: 'Cabrio ZK3.5x85 85-300 T2.9-4.0', focalLengthMin: 85, focalLengthMax: 300, maxApertureWide: 2.9, maxApertureTele: 4.0, mount: 'PL', imageCircle: 'S35', type: 'zoom' },
  { id: 'fuj-cabrio-25-300', manufacturer: 'Fujinon', model: 'Cabrio ZK12x25 25-300 T3.5-4.2', focalLengthMin: 25, focalLengthMax: 300, maxApertureWide: 3.5, maxApertureTele: 3.85, mount: 'PL', imageCircle: 'S35', type: 'zoom' },
  ...
  { id: 'ang-optimo-ultra-12x', manufacturer: 'Angénieux', model: 'Optimo Ultra 12x 24-290 T2.8', focalLengthMin: 24, focalLengthMax: 290, maxApertureWide: 2.8, mount: 'PL', imageCircle: 'S35', type: 'zoom' },
  ...
  { id: 'sony-fe-24-240', manufacturer: 'Sony', model: 'FE 24-240 F3.5-6.3', focalLengthMin: 24, focalLengthMax: 240, maxApertureWide: 3.5, maxApertureTele: 6.3, mount: 'E', imageCircle: 'FF', type: 'zoom' },
  ...
  { id: 'sony-fe-200-600g', manufacturer: 'Sony', model: 'FE 200-600 F5.6-6.3 G', focalLengthMin: 200, focalLengthMax: 600, maxApertureWide: 5.6, maxApertureTele: 6.3, mount: 'E', imageCircle: 'FF', type: 'zoom' },
  { id: 'sony-fe-400-800g', manufacturer: 'Sony', model: 'FE 400-800 F6.3-8 G', focalLengthMin: 400, focalLengthMax: 800, maxApertureWide: 6.3, maxApertureTele: 8, mount: 'E', imageCircle: 'FF', type: 'zoom' },
  ...
  { id: 'nikon-z-100-400', manufacturer: 'Nikon', model: 'Z 100-400 f/4.5-5.6 S', focalLengthMin: 100, focalLengthMax: 400, maxApertureWide: 4.5, maxApertureTele: 5.6, mount: 'Z', imageCircle: 'FF', type: 'zoom' },
  { id: 'nikon-z-180-600', manufacturer: 'Nikon', model: 'Z 180-600 f/5.6-6.3', focalLengthMin: 180, focalLengthMax: 600, maxApertureWide: 5.6, maxApertureTele: 6.3, mount: 'Z', imageCircle: 'FF', type: 'zoom' },
  ...
  { id: 'nikon-z-400-28', manufacturer: 'Nikon', model: 'Z 400 f/2.8 TC VR S', focalLengthMin: 400, focalLengthMax: 400, maxApertureWide: 2.8, mount: 'Z', imageCircle: 'FF', extenderFactors: [1.4], type: 'prime' },
  { id: 'nikon-z-600-4', manufacturer: 'Nikon', model: 'Z 600 f/4 TC VR S', focalLengthMin: 600, focalLengthMax: 600, maxApertureWide: 4.0, mount: 'Z', imageCircle: 'FF', extenderFactors: [1.4], type: 'prime' },
  ...
  { id: 'canon-rf-100-400', manufacturer: 'Canon', model: 'RF 100-400 f/5.6-8', focalLengthMin: 100, focalLengthMax: 400, maxApertureWide: 5.6, maxApertureTele: 8, mount: 'RF', imageCircle: 'FF', type: 'zoom' },
  { id: 'canon-rf-100-500', manufacturer: 'Canon', model: 'RF 100-500 f/4.5-7.1 L', focalLengthMin: 100, focalLengthMax: 500, maxApertureWide: 4.5, maxApertureTele: 7.1, mount: 'RF', imageCircle: 'FF', type: 'zoom' },
  { id: 'canon-rf-200-800', manufacturer: 'Canon', model: 'RF 200-800 f/6.3-9', focalLengthMin: 200, focalLengthMax: 800, maxApertureWide: 6.3, maxApertureTele: 9, mount: 'RF', imageCircle: 'FF', type: 'zoom' },
  ...
  { id: 'canon-cne-30-105', manufacturer: 'Canon', model: 'CN-E 30-105 T2.8', focalLengthMin: 30, focalLengthMax: 105, maxApertureWide: 2.8, mount: 'EF', imageCircle: 'S35', type: 'zoom' },
  { id: 'canon-cne-30-300', manufacturer: 'Canon', model: 'CN-E 30-300 T2.95-3.7', focalLengthMin: 30, focalLengthMax: 300, maxApertureWide: 2.95, mount: 'EF', imageCircle: 'S35', type: 'zoom' },
  { id: 'canon-cne-18-80', manufacturer: 'Canon', model: 'CN-E 18-80 T4.4', focalLengthMin: 18, focalLengthMax: 80, maxApertureWide: 4.4, mount: 'EF', imageCircle: 'S35', type: 'zoom' },
  { id: 'canon-cne-70-200', manufacturer: 'Canon', model: 'CN-E 70-200 T4.4', focalLengthMin: 70, focalLengthMax: 200, maxApertureWide: 4.4, mount: 'EF', imageCircle: 'S35', type: 'zoom' },
  ...
  { id: '7artisans-cine-25', manufacturer: '7Artisans', model: 'Vision 25mm T1.05', focalLengthMin: 25, focalLengthMax: 25, maxApertureWide: 1.05, mount: 'E', imageCircle: 'S35', type: 'prime' },
  { id: '7artisans-cine-35', manufacturer: '7Artisans', model: 'Vision 35mm T1.05', focalLengthMin: 35, focalLengthMax: 35, maxApertureWide: 1.05, mount: 'E', imageCircle: 'S35', type: 'prime' },
  { id: '7artisans-cine-50', manufacturer: '7Artisans', model: 'Vision 50mm T1.05', focalLengthMin: 50, focalLengthMax: 50, maxApertureWide: 1.05, mount: 'E', imageCircle: 'S35', type: 'prime' },
  { id: 'ttartisan-35', manufacturer: 'TTArtisan', model: '35mm f/1.4 (Foto)', focalLengthMin: 35, focalLengthMax: 35, maxApertureWide: 1.4, mount: 'E', imageCircle: 'APSC', type: 'prime' },
  ...
  { id: 'zeiss-ultraprime-10', manufacturer: 'Zeiss', model: 'Ultra Prime 10mm T1.9', focalLengthMin: 10, focalLengthMax: 10, maxApertureWide: 2.1, mount: 'PL', imageCircle: 'S35', type: 'prime' },
  { id: 'zeiss-ultraprime-12', manufacturer: 'Zeiss', model: 'Ultra Prime 12mm T1.9', focalLengthMin: 12, focalLengthMax: 12, maxApertureWide: 2.0, mount: 'PL', imageCircle: 'S35', type: 'prime' },
  ...
  { id: 'canon-k35-85', manufacturer: 'Canon', model: 'K35 85mm T1.5', focalLengthMin: 85, focalLengthMax: 85, maxApertureWide: 1.3, mount: 'PL', imageCircle: 'S35', type: 'prime' },
  // ── Anamorphoten-Rental-Klassiker (2x Squeeze) ──
  // Panavision Primo (S35, T2) 
  { id: 'panavision-primo-27', manufacturer: 'Panavision', model: 'Primo 27mm T2', focalLengthMin: 27, focalLengthMax: 27, maxApertureWide: 1.9, mount: 'PL', imageCircle: 'S35', type: 'prime' },
  { id: 'panavision-primo-35', manufacturer: 'Panavision', model: 'Primo 35mm T2', focalLengthMin: 35, focalLengthMax: 35, maxApertureWide: 1.9, mount: 'PL', imageCircle: 'S35', type: 'prime' },
  { id: 'panavision-primo-40', manufacturer: 'Panavision', model: 'Primo 40mm T2', focalLengthMin: 40, focalLengthMax: 40, maxApertureWide: 1.9, mount: 'PL', imageCircle: 'S35', type: 'prime' },
  { id: 'panavision-primo-50', manufacturer: 'Panavision', model: 'Primo 50mm T2', focalLengthMin: 50, focalLengthMax: 50, maxApertureWide: 1.9, mount: 'PL', imageCircle: 'S35', type: 'prime' },
  { id: 'panavision-primo-75', manufacturer: 'Panavision', model: 'Primo 75mm T2', focalLengthMin: 75, focalLengthMax: 75, maxApertureWide: 1.9, mount: 'PL', imageCircle: 'S35', type: 'prime' },
  { id: 'panavision-primo-100', manufacturer: 'Panavision', model: 'Primo 100mm T2', focalLengthMin: 100, focalLengthMax: 100, maxApertureWide: 1.9, mount: 'PL', imageCircle: 'S35', type: 'prime' },
  { id: 'panavision-primo-150', manufacturer: 'Panavision', model: 'Primo 150mm T2', focalLengthMin: 150, focalLengthMax: 150, maxApertureWide: 1.9, mount: 'PL', imageCircle: 'S35', type: 'prime' },
  ...
  { id: 'panavision-cseries-30', manufacturer: 'Panavision', model: 'C-Series 30mm T2.3', focalLengthMin: 30, focalLengthMax: 30, maxApertureWide: 3.0, mount: 'PL', imageCircle: 'S35', type: 'prime', squeeze: 2 },
  ...
  { id: 'panavision-cseries-40', manufacturer: 'Panavision', model: 'C-Series 40mm T2.3', focalLengthMin: 40, focalLengthMax: 40, maxApertureWide: 2.8, mount: 'PL', imageCircle: 'S35', type: 'prime', squeeze: 2 },
  ...
  { id: 'panavision-cseries-60', manufacturer: 'Panavision', model: 'C-Series 60mm T2.3', focalLengthMin: 60, focalLengthMax: 60, maxApertureWide: 2.8, mount: 'PL', imageCircle: 'S35', type: 'prime', squeeze: 2 },
  { id: 'panavision-cseries-75', manufacturer: 'Panavision', model: 'C-Series 75mm T2.3', focalLengthMin: 75, focalLengthMax: 75, maxApertureWide: 2.5, mount: 'PL', imageCircle: 'S35', type: 'prime', squeeze: 2 },
  { id: 'panavision-cseries-100', manufacturer: 'Panavision', model: 'C-Series 100mm T2.3', focalLengthMin: 100, focalLengthMax: 100, maxApertureWide: 2.8, mount: 'PL', imageCircle: 'S35', type: 'prime', squeeze: 2 },
  ...
  { id: 'kowa-prominar-75', manufacturer: 'Kowa', model: 'Prominar 75mm T2.3', focalLengthMin: 75, focalLengthMax: 75, maxApertureWide: 2.8, mount: 'PL', imageCircle: 'S35', type: 'prime', squeeze: 2 },
  { id: 'kowa-prominar-100', manufacturer: 'Kowa', model: 'Prominar 100mm T2.3', focalLengthMin: 100, focalLengthMax: 100, maxApertureWide: 3.4, mount: 'PL', imageCircle: 'S35', type: 'prime', squeeze: 2 },
  ...
  { id: 'scorpio-ana-40', manufacturer: 'Servicevision', model: 'Scorpio 40mm T2.4', focalLengthMin: 40, focalLengthMax: 40, maxApertureWide: 2.2, mount: 'PL', imageCircle: 'FF', type: 'prime', squeeze: 2 },
  { id: 'scorpio-ana-50', manufacturer: 'Servicevision', model: 'Scorpio 50mm T2.4', focalLengthMin: 50, focalLengthMax: 50, maxApertureWide: 2.2, mount: 'PL', imageCircle: 'FF', type: 'prime', squeeze: 2 },
  { id: 'scorpio-ana-75', manufacturer: 'Servicevision', model: 'Scorpio 75mm T2.4', focalLengthMin: 75, focalLengthMax: 75, maxApertureWide: 2.2, mount: 'PL', imageCircle: 'FF', type: 'prime', squeeze: 2 },
  { id: 'scorpio-ana-100', manufacturer: 'Servicevision', model: 'Scorpio 100mm T2.4', focalLengthMin: 100, focalLengthMax: 100, maxApertureWide: 2.2, mount: 'PL', imageCircle: 'FF', type: 'prime', squeeze: 2 },
  { id: 'scorpio-ana-135', manufacturer: 'Servicevision', model: 'Scorpio 135mm T2.4', focalLengthMin: 135, focalLengthMax: 135, maxApertureWide: 2.2, mount: 'PL', imageCircle: 'FF', type: 'prime', squeeze: 2 },
  // P+S Technik Evolution 2x (FF, T2.4) 
  { id: 'psk-evolution-40', manufacturer: 'P+S Technik', model: 'Evolution 2x 40mm T2.4', focalLengthMin: 40, focalLengthMax: 40, maxApertureWide: 2.4, mount: 'PL', imageCircle: 'S35', type: 'prime', squeeze: 2 },
  { id: 'psk-evolution-100', manufacturer: 'P+S Technik', model: 'Evolution 2x 100mm T2.4', focalLengthMin: 100, focalLengthMax: 100, maxApertureWide: 2.5, mount: 'PL', imageCircle: 'FF', type: 'prime', squeeze: 2 },
  ...
  { id: 'zeiss-cp2-15', manufacturer: 'Zeiss', model: 'CP.2 15mm T2.1', focalLengthMin: 15, focalLengthMax: 15, maxApertureWide: 2.9, mount: 'EF', imageCircle: 'FF', type: 'prime' },
  ...
  { id: 'tokina-vistaone-80', manufacturer: 'Tokina', model: 'Vista One 85mm T1.5', focalLengthMin: 85, focalLengthMax: 85, maxApertureWide: 1.5, mount: 'PL', imageCircle: 'FF', type: 'prime' },
