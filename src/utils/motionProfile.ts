...
export const MOTION_PROFILES: Record<CameraMountType, MotionProfile> = {
  tripod: {
    label: 'Tripod',
    hint: 'A short, precise pan with a clean start and stop.',
    ease: easeCubic,
  ...
  hihat: {
    label: 'Hi-Hat',
    hint: 'Low and rigid - pan and tilt only.',
    ease: easeCubic,
  ...
  pedestal: {
    label: 'Pedestal',
    hint: 'Cleanly guided, the column raises and lowers evenly.',
    ease: easeCubic,
  ...
  jib: {
    label: 'Jib / Crane',
    hint: 'A soft arc that settles gently.',
    ease: easeQuintic,
  ...
  technocrane: {
    label: 'Technocrane',
    hint: 'A telescoping arm - the softest and longest move.',
    ease: easeQuintic,
  ...
  dolly: {
    label: 'Dolly',
    hint: 'Heavy mass: a long run-up and a long roll-out.',
    ease: easeQuintic,
  ...
  slider: {
    label: 'Slider',
    hint: 'A short, very even path - fine control.',
    ease: easeCubic,
  ...
  cablecam: {
    label: 'Cable-Cam',
    hint: 'Flying on ropes - wide, soft arcs with a little sway afterwards.',
    ease: easeSettle,
  ...
  drone: {
    label: 'Drone',
    hint: 'Free in space, soft acceleration, slight drift.',
    ease: easeQuad,
  ...
  scissorlift: {
    label: 'Scissor lift',
    hint: 'Lifts slowly and calmly; barely moves horizontally.',
    ease: easeQuintic,
  ...
  remotehead: {
    label: 'Remote-Head',
    hint: 'Motor-precise, very fast pans are possible.',
    ease: easeCubic,
  ...
  carmount: {
    label: 'Vehicle',
    hint: 'Follows the vehicle - fast, with road judder.',
    ease: easeQuad,
  ...
  rickshaw: {
    label: 'Rickshaw',
    hint: 'Pushed - even, but never entirely still.',
    ease: easeQuintic,
  ...
  gimbal: {
    label: 'Gimbal',
    hint: 'Softly guided, nimbler than a Steadicam.',
    ease: easeQuad,
  ...
  steadicam: {
    label: 'Steadicam',
    hint: 'Floating, overshoots a little and settles in.',
    ease: easeSettle,
  ...
  handheld: {
    label: 'Handheld',
    hint: 'Never entirely still - a fine tremor rides on the move.',
    ease: easeQuad,
  ...
  fixed: {
    label: 'Fixed mount',
    hint: 'Rigid - zoom and focus only, no travel.',
    ease: easeCubic,
